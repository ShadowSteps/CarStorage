...
class IndexClustering
{
    ...
    public function __construct(string $solrAddress)
    {
        ...
        $this->documentHelper = new DocumentHelper($this->features);
    }
    ...
    private function findBestFacilities(DocumentsQueue $queue, float $facilityCost, int $maxFacilities, float $progressSpeed = 3.0): array
    {
        /**
    ...
    {
        list($trainingSet, $trainingResults) = $this->documentHelper->defineSets($centroids);
